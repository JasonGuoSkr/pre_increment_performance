...
# 数据导入
df_pre = pd.read_csv(inputPath + "汇总个股买卖时点_2020-02-18.csv", index_col=0, engine='python')
df_pre.drop_duplicates(inplace=True)
df_pre.sort_values(by='buy_date', axis=0, ascending=True, inplace=True)
df_pre = df_pre.reset_index(drop=True)

df_post = pd.read_csv(inputPath + "汇总个股买卖时点_2020-03-01.csv", index_col=0, engine='python')
